...
export function MovieCard({ movie }) {
  ...
  return (
    <Link to={`/movie/${movie.id}`} className="group relative flex flex-col">
      <div className="flex flex-col bg-gray-900 rounded-lg overflow-hidden hover:scale-105 transition-transform border border-gray-800 transition-all hover:border-red-600/50">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill={favorited ? "white" : "none"} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
